...
This gem continued the great work done by Danandrews in [`omniauth-okta`](https://github.com/dandrews/omniauth-okta) as well as the great work done by andrew.vanbeek@okta.com in [`omniauth-oktaoauth`](https://github.com/andrewvanbeek-okta/omniauth-oktaoauth).  But honestly their gem is more updated so please use that one.  Also not an official sdk from Okta.
